...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/crimson-pine-e88b
```

A live public deployment of this template is available at [https://crimson-pine-e88b.templates.workers.dev](https://crimson-pine-e88b.templates.workers.dev)
